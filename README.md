[![MATLAB](https://github.com/AvroRJX/ci-configuration-examples/actions/workflows/
ci.yml/badge.svg)](https://github.com/AvroRJX/ci-configuration-examples/actions/
workflows/ci.yml)
